...
export const ListadoMascotasUsuario = () => {
    ...
    const historialClinico = (props) => {
      navigate("/ListadoHistorias/" + props)
    }
                  ...
                  {mascotas.map((response, index) =>
                    <tbody>
                      <tr>
                        ...
                        <td className="py-4 border-b border-gray-200 bg-white text-sm">
                          <a onClick={() => historialClinico(response.numeroIdentidad)} href="#" className="text-dark-purple hover:text-blue-900">
                            Historial clínico
                          </a>
                        </td>
                      </tr>
