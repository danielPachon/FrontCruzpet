...
export const ActualizarProducto = () => {
  ...
  useEffect(() => {
        ...
        axios.get("https://api.cruzpet.com:8443/v1.0/productos/" + id).then((response) => {
            ...
            setIpsa(response.data.ipsaEntity.rut)
        })
  ...
  const validarCampos = () => {
    ...
    actualizar(objetoProducto)

  }

  const actualizar = (objeto) => {
    console.log(objeto.totalCalificacion)
    axios.put("https://api.cruzpet.com:8443/v1.0/productos/actualizarepsa", {
      idProducto: id,
              ...
              <div className="px-4 py-5 bg-white sm:p-6">
                ...
                <div className="grid grid-cols-6 gap-6">
                  <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                    ...
                    <input type="text" ref={nombreProductoAct} placeholder={producto.nombreProducto} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                  </div>
                </div>
                <div className="grid grid-cols-6 gap-6">
                  <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                    ...
                    <input type="text" ref={precioProductoAct} placeholder={producto.precioproducto} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                  </div>
                </div> 
                <div className="grid grid-cols-6 gap-6">
                  <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                    ...
                    <input type="text" ref={totalCalificacionAct} placeholder={producto.totalCalificacion} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                  </div>
                </div>                
                    ...
                    >
                      {
                        listaIpsas.map((response) =>
                           ...
                           <option selected={response.rut === ipsa}>{response.rut}</option> 
                        )
                      }
