...
export const ConfigEPSA = () => {
  ...
  useEffect(() => {
    axios.post('https://api.cruzpet.com:8443/v1.0/administradores/administradorid', {
      ...
      setNombreIpsa(response.data.nombreAdministrador)
      setCorreoIpsa(response.data.correAdministrador)
    })
  }, [])
  ...
  async function actualizarIpsa() {
    const updateAdmin = {
      ...
      nombreAdministrador: nombreIpsa,
      correAdministrador: correoIpsa,
      estado: "a",
    }

    await axios.put('https://api.cruzpet.com:8443/v1.0/administradores/actualizar', updateAdmin, {
      headers: {
  ...
  return (
    <div>
      ...
      <div className='pl-20 mt-4'>
        <form onSubmit={validateForm} className='relative m-4 p-4 flex flex-col min-w-0 bg-white bg-clip-border border-1 border-solid shadow-sm rounded-xl justify-center overflow-hidden max-w-full'>
          <div className='w-full'>
            <div className='grid grid-cols-2 gap-3 w-full'>
              <div className="relative">
                ...
                <label for="nombreIpsa" className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-800 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Nombre de la Admin</label>
              </div>
              <div className="relative">
                ...
                <label for="correoIpsa" className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-800 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Correo de la Admin</label>
              </div>
            ...
            <div className="w-full mt-3 flex flex-col text-center">
