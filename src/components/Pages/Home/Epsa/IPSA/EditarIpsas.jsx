...
export const EditarIpsas = () => {
  ...
  useEffect(() => {
    axios.post("https://api.cruzpet.com:8443/v1.0/ipsas/ipsarut", {
      ...
      setIpsaNuevo(response.data)
      setEstado(response.data.estado)
      setDepartamentos(response.data.ubicacion.barrios.ciudadOrigen.departamentoOrigen.nombreDepartamento)
      setCiudades(response.data.ubicacion.barrios.ciudadOrigen.nombreCiudad)
      setBarrios(response.data.ubicacion.barrios.nombreBarrio)
      setDirecciones(response.data.ubicacion.direccionCasa)
      axios.post("https://api.cruzpet.com:8443/v1.0/ciudades/ciudadesnombredepartamento", {
        departamentoOrigen: {
          nombreDepartamento: response.data.ubicacion.barrios.ciudadOrigen.departamentoOrigen.nombreDepartamento
        }
      }).then((responses) => {
  ...
  const validarCampos = () => {
    ...
    if (rutAct.current.value !== "") {
      ...
      objetoIpsaNuevo.rut = rutAct.current.placeholder
    }

    if (nombreAct.current.value !== "") {
      objetoIpsaNuevo.nombreIpsa = nombreAct.current.value
    } else {
      objetoIpsaNuevo.nombreIpsa = nombreAct.current.placeholder
    }
  ...
  const actualizar = (objeto) => {
    axios.put("https://api.cruzpet.com:8443/v1.0/ipsas/actualizarsincontralogo", {
      rut: objeto.rut,
  ...
  const validarBarrio = (objeto) => {
    ...
    if (barrioAct.current.value !== "") {
      ...
      axios.post("https://api.cruzpet.com:8443/v1.0/barrios/mostrarbarriociudad", {
        nombreBarrio: nombreAct.current.placeholder,
        ciudadOrigen: {
          idCiudad: objeto.nombreCiudad
        }
      }).then((response) => {
  ...
  const valBarrio = (objeto) => {
    ...
    if (direccionAct.current.value !== "") {
      ...
      axios.post("https://api.cruzpet.com:8443/v1.0/direcciones/traerdireccionnombre", {
        direccionCasa: direccionAct.current.placeholder,
        barrios: {
          idBarrio: objeto.nombreBarrio
        }
      }).then((response) => {
              ...
              <div className="px-4 py-5 bg-white sm:p-6">
                ...
                <div className="grid grid-cols-6 gap-6">
                  ...
                  <div className="col-span-6 sm:col-span-3 lg:col-span-1">
                    ...
                    <input type="text" ref={rutAct} placeholder={ipsaNuevo.rut} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                  </div>
                  ...
                  <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                    ...
                    <input type="text" ref={nombreAct} placeholder={ipsaNuevo.nombre} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                  </div>
                  ...
                  <div className="col-span-6 sm:col-span-2">
                    ...
                    <input type='text' placeholder={direcciones} ref={direccionAct} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                  </div>
                  ...
                  <div className="col-span-6 sm:col-span-6 lg:col-span-2">
                    ...
                    <input type="text" placeholder={barrios} ref={barrioAct} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                  </div>
                </div>
              </div>
