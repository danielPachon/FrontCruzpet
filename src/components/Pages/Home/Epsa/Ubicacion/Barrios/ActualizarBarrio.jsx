...
export const ActualizarBarrio = () => {
    ...
    useEffect(() => {
        ...
        axios.post("https://api.cruzpet.com:8443/v1.0/barrios/mostrarbarrioid",{
            idBarrio: id
        }).then((response) => {
            setBarrio(response.data)
            setDepartamento(response.data.ciudadOrigen.departamentoOrigen.nombreDepartamento)
            setCiudad(response.data.ciudadOrigen.nombreCiudad)
        })
    ...
    const validarBarrio  = (objeto) => { 
        ...
        if(nombreBarrioAct.current.value !== ""){
            ...
            objeto.nombreBarrio = nombreBarrioAct.current.placeholder
            validarCodigoPostal(objeto)
        }
    }
    ...
    const validarCodigoPostal = (objeto) => {
        ...
        if(codigoPostalAct.current.value !== ""){
            ...
            objeto.codigoPostal = codigoPostalAct.current.placeholder
        }
    ...
    const actualizar = (objeto) => {
        console.log(objeto.nombreBarrio)
        axios.put("https://api.cruzpet.com:8443/v1.0/barrios/actualizar", {
            idBarrio: id,
                    ...
                    <div className="px-4 py-5 bg-white sm:p-6">
                      ...
                      <div className="grid grid-cols-6 gap-6">
                        <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                          ...
                          <input type="text" ref={nombreBarrioAct} placeholder={barrio.nombreBarrio} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                        </div>
                        ...
                        <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                          ...
                          <input type="text" ref={codigoPostalAct} placeholder={barrio.codigoPostal} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                        </div>
