...
export function ListadoBarrios() {
  ...
  const traerBarrios = () => {
    axios.get(`https://api.cruzpet.com:8443/v1.0/barrios/barriospaginador?size=6&page=${pagina}`).then((response) => {
                ...
                {barrios.map((response) =>
                  <tbody>
                    <tr>
                      ...
                      <td className="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                        <p className="text-gray-900 whitespace-no-wrap">
                          {response.ciudadOrigen.nombreCiudad}
                        </p>
                      </td>
                      <td className="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                        <p className="text-gray-900 whitespace-no-wrap">
                          {response.ciudadOrigen.departamentoOrigen.nombreDepartamento}
                        </p>
                      </td>
                      <td className="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                        <p className="text-gray-900 whitespace-no-wrap">
                      ...
                      <td className="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                        <a onClick={() => actualizar(response.idBarrio)} className="text-dark-purple hover:text-blue-900">
                          Editar
                        </a>
                      </td>
                    </tr>
