...
export function ListadoMedicamentos() {
  ...
  const traerMedicamentos = () => {
    axios.get(`https://api.cruzpet.com:8443/v1.0/medicamentos/traermedicamentospaginador?size=6&page=${pagina}`).then((response) => {
      setMedicamentos(response.data.content)
    })
  }
                    ...
                    <tr>
                      ...
                      <td className="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                        <div className="flex items-center">
                          <div className="ml-3">
                            <p className="text-gray-900 whitespace-no-wrap">
                              {response.descripcionMedicamento}
                            </p>
                          </div>
                      ...
                      <td className="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                        <a onClick={() => navigate("/Medicamentos/" + response.idMedicamento)} href="#" className="text-dark-purple hover:text-blue-900">
                          Editar
                        </a>
                      </td>
                    </tr>
