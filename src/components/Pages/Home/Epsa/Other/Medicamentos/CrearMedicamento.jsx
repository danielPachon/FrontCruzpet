...
export const CrearMedicamento = () => {
    ...
    const validarCampos = () => {
        ...
        crear(objetoMedicamento)
    }
  
    const crear = (objeto) => {
      axios.post("https://api.cruzpet.com:8443/v1.0/medicamentos/crear", {
                ...
                <div className="px-4 py-5 bg-white sm:p-6">
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                      ...
                      <input type="text" ref={nombreMedicamentoAct} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
                    <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                      <label htmlFor="region" className="block text-sm font-medium text-gray-700">
                        Descripcion Medicamento
                      </label>
                      <input type="text" ref={descripcionMedicamentoAct} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
