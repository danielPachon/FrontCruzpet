...
export const ListadoMascotaFormulas = () => {
    ...
    const formulas = (props) => {
      ...
      navigate("/ListadoFormulas/" + props)
                  ...
                  {mascotas.map((response, index) =>
                    <tbody>
                      <tr>
                        ...
                        <td className="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                          <a onClick={() => formulas(response.numeroIdentidad)} href="#" className="text-dark-purple hover:text-blue-900">
                            Formulas
                          </a>
                        </td>
                      </tr>
