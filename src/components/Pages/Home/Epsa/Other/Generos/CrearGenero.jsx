...
export const CrearGenero = () => {
    ...
    const validarCampos = () => {
      if (nombreGeneroAct.current.value !== "") {
        ...
        crear(nombreGeneroAct.current.value)
  
      } else {

        alert("Campo nombre Genero vacio")
      }
    }
  
    const crear = (objeto) => {
      axios.post("https://api.cruzpet.com:8443/v1.0/generos/crear", {
        genero: objeto,
                ...
                <div className="px-4 py-5 bg-white sm:p-6">
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                      ...
                      <input type="text" ref={nombreGeneroAct} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
