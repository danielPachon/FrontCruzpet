...
export function ListadoServicios() {
  ...
  const traerServicios = () => {
    axios.get(`https://api.cruzpet.com:8443/v1.0/servicios/serviciospaginador?size=6&page=${pagina}`).then((response) => {
  ...
  const eliminarServicio = (prop) => {

    axios.delete("https://api.cruzpet.com:8443/v1.0/servicios/eliminar/" + prop).then(() => {
      traerServicios()
    })
          ...
          <div className="flex flex-col md:flex-row mb-1 sm:mb-0 justify-between w-full">
            ...
            <div className="text-end">
              <form className="flex flex-col md:flex-row w-full md:w-full max-w-2xl md:space-x-3 space-y-3 md:space-y-0 justify-center">
                ...
                <NavLink to={'/Servicios/Epsa/Crear'}>
                ...
                {servicios.map((response) =>
                  <tbody>
                    <tr>
                        ...
                        <div className="flex items-center">
                          <div className="flex-shrink-0">
                            <a href="#" className="block relative">
                              <img alt="Photo" src={response.rutaImagenServicio} className="mx-auto object-cover rounded-full h-10 w-10 " />
                            </a>
                          </div>
                          <div className="ml-3">
                      ...
                      <td className="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                        <a onClick={() => navigate("/Servicios/Epsa/" + response.idServicio)} className="text-dark-purple hover:text-blue-900">
                          Editar
                        </a>
                      </td>
                      <td className="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                        <a onClick={() => eliminarServicio(response.idServicio)} className="text-dark-purple hover:text-blue-900">
                          Eliminar
                        </a>
                      </td>
                    </tr>
