    ...
    const validarCampos = () => {
        ...
        if(nombreRazaAct.current.value !== ""){
            ...
            tipoMascota:tipoMascota
              ...
              crear(objetoRaza, response.data.idTipoMascota)
            })
        }else{
            alert("El campo nombre raza no se escribio")
        }
    }

    const crear = (objeto, idTipoMascota) => {
        axios.post("https://api.cruzpet.com:8443/v1.0/razas/crear", {
                ...
                <div className="px-4 py-5 bg-white sm:p-6">
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                      ...
                      <input type="text" ref={nombreRazaAct} className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
                  </div>
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-3 lg:col-span-2">
