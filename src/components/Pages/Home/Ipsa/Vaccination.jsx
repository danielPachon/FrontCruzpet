...
export default function Vaccination() {
    ...
    const warnPets = () => toast.warn('El usuario no tiene mascotas registradas.', {
        position: "top-right",
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,
                ...
                {mascotas.map(mascota =>
                    <div key={mascota.numeroIdentidad} className="bg-white w-full my-2 mx-1 sm:w-1/4 md:w-1/3 lg:w-1/3 md:max-w-screen-sm min-w-0 p-3 border rounded-lg overflow-hidden shadow-lg ">
                        ...
                        <div className="flex justify-center items-center px-6 py-2">
                            <button type="button" value={mascota.numeroIdentidad} onClick={e => navigate("/Admin/Ipsa/Vaccination/"+e.target.value)} className="bg-white text-teal-800 font-semibold py-1 px-3 border border-gray-500 rounded-lg shadow-md">
                        ...
                        <div className="flex items-stretch md:items-center justify-center min-h-full text-center md:px-2 lg:px-4">
                            ...
                            >
                                <Dialog.Panel className="flex text-base text-left transform transition w-full md:max-w-2xl md:px-4 md:my-8 lg:max-w-3xl xl:max-w-xl 2xl:max-w-5xl">
                                    <form onSubmit={exitenciaCliente} className="w-full relative flex items-center bg-white px-4 pt-14 pb-8 overflow-hidden shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                                        <div className='flex-col w-full'>
                                            ...
                                            <div className="flex-row px-12 w-full my-6 justify-center items-center text-center">
                                                <div className="relative">
                                                    <input required type="text" onChange={e => setCedulaCliente(e.target.value)} id="documento" className="block px-2.5 pb-1.5 pt-3 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
